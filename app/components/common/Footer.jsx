  ...
  <footer className="bg-[#0e384c] w-full">
    <Container>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center border-b border-white/10 pt-[50px] pb-10 gap-6">
        <h2 className="text-white text-[40px] font-bold font-onest leading-[48px] mb-4 md:mb-0">
          Your Healthier Smile Awaits - Book Now!
        </h2>
        <a
          href="/contact"
          className="flex items-center gap-3 px-6 py-4 bg-[#1e84b5] rounded-[14px] outline outline-1 outline-white/10 text-white text-base font-semibold font-onest leading-[17.6px] transition hover:bg-[#176b91]"
        >
          Book Appointment
        ...
        <div className="flex-1 min-w-[220px] max-w-[400px]">
          <div className="flex items-center gap-2 mb-4">
            <svg width="38" height="48" viewBox="0 0 38 48" fill="none">
              <path d="M19 46C28.3888 46 36 38.3888 36 29C36 19.6112 28.3888 12 19 12C9.61116 12 2 19.6112 2 29C2 38.3888 9.61116 46 19 46Z" stroke="#1e84b5" strokeWidth="4"/>
              <circle cx="19" cy="29" r="7" stroke="#1e84b5" strokeWidth="4"/>
            </svg>
            <span className="text-white text-2xl font-bold font-onest">Primecare</span>
          </div>
